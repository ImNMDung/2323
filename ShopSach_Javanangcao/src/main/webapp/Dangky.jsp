...
<form action="dangkyctl" method="post">
  <div class="container">
    <h1> Đăng Ký</h1>
    <%
    ...
    <input type="password" placeholder="Nhập Mật Khẩu" name="mk" required>
...
<form action="ktdn" >
  <div class="container">
  <div class="clearfix">
      <button  name="bxtdk" type="submit" class="signupbtn">Đăng Nhập</button>
